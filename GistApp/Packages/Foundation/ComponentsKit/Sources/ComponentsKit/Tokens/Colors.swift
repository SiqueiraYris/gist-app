...
public struct Colors {
    public static let background = UIColor(hexString: "#1E1E1E")
    public static let gray_100 = UIColor(hexString: "#FBF9FE")
    public static let gray_200 = UIColor(hexString: "#AFABB6")
